...
public class MasterSystem {
    ...
    public static void start() {
        ...
        ActorRef passwordCracker = system.actorOf(PasswordCracker.props(), PasswordCracker.DEFAULT_NAME);

        ActorRef hintCracker = system.actorOf(HintCracker.props(passwordCracker), HintCracker.DEFAULT_NAME);

        ActorRef cracker = system.actorOf(Cracker.props(hintCracker, passwordCracker), Cracker.DEFAULT_NAME);

        ActorRef master = system.actorOf(Master.props(reader, collector, cracker), Master.DEFAULT_NAME);
